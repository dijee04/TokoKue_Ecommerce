    ...
    <section class="hero">
        <div class="container hero-container">
            <div class="hero-text">
                ...
                <p class="hero-subtitle">Hadirkan senyuman di momen berharga Anda bersama mahakarya rasa dari Anis Bakery.
                </p>
    ...
    <section class="promise-section container">
        ...
        <div class="promise-layout">
            ...
            <div class="promise-right gallery-grid">
                ...
                <div class="gal-item"><img src="{{ asset('assets/img_produk/vanilla_chocolate_cupcake.png') }}"
                        alt="Gallery 3"></div>
